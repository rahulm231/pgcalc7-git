...
<?php foreach($sync_items as $site_name => $sync_item): ?>
  ...
  $edit_link = $domain.'/admin/custom-variables';
  ?>
<table>
  <thead>
  ...
  <?php elseif($sync_item['status'] == PGC_SYNC_NEEDS_REVIEW): ?>
    ...
    <tr>
      <td colspan="2">
        <a href="/admin/pgc-sync/global-variables/force/<?php print $sync_info['id']; ?>/<?php print $site_name; ?>">Force update</a>
        | <a href="/admin/pgc-sync/global-variables/skip/<?php print $sync_info['id']; ?>/<?php print $site_name; ?>">Skip update</a>
        | <a href="/admin/pgc-sync/global-variables/complete/<?php print $sync_info['id']; ?>/<?php print $site_name; ?>">Mark as complete</a>
