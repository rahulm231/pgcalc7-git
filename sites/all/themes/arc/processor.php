...
$responseDate = date('h:i:s:u'); list($hrs,$mins,$secs,$msecs) = split(':',$responseDate); 
...
if ($err<=0) {
	...
	if ( ($lander_type=="Professional WG Request")) {header("Location: http://www.redcrosslegacy.org/mailers/ARC-Wills-Guide-Offer-Professionals-Lander-Thanks.php");}
//Lander Type: Donor Mailing WG Request
	if (($lander_type=="Donor Mailing WG Request")  ) {header("Location: http://www.redcrosslegacy.org/mailers/ARC-Wills-Guide-Offer-Donor-Mailing-Lander-Thanks.php");}
	if (($lander_type=="Digital Campaign WG Request")  ) {header("Location: http://www.redcrosslegacy.org/mailers/ARC-Wills-Guide-Digital-Campaign-Lander-Thanks.php");} 
	if (($lander_type=="Digital Campaign General Gift Planning Info Request") ||($referrer=="http://www.redcrosslegacy.org/giftsummary")  ) {header("Location: http://www.redcrosslegacy.org/mailers/ARC-General-Gift-Planning-Lander-Thanks.php");} 
	if (($lander_type=="Legacy Newsletter WG Request")  ) {header("Location: http://www.redcrosslegacy.org/mailers/ARC-Wills-Guide-Donor-Email-Lander-Thanks.php");} 
	if (($lander_type=="Donor Mailing CGA Illustration Request")  ) {header("Location: http://www.redcrosslegacy.org/mailers/ARC-CGA-Mailing-Campaign-Lander-Thanks.php");} 
	if (($lander_type=="Digital Campaign CGA Illustration Request")  ) {header("Location: http://www.redcrosslegacy.org/mailers/ARC-CGA-Digital-Campaign-Lander-Thanks.php");}
	if ( ($lander_type=="Donor Email WG Request")) {header("Location: http://www.redcrosslegacy.org/mailers/ARC-Wills-Guide-Donor-Email-Lander-Thanks.php");}
	if ( ($lander_type=="Donor Email CGA Illustration Request")) {header("Location: http://www.redcrosslegacy.org/mailers/ARC-CGA-Donor-Mailing-Email-Lander-Thanks.php");}
	if ( ($lander_type=="Make a Will Month")) {header("Location: http://www.redcrosslegacy.org/mailers/ARC-Make-a-Will-Thanks.php");}
	}	
}   
