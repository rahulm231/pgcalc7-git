        ...
        _createHtml: function(isValid) {
            ...
            for(var i=0,j=this.options.linkText.length;i<j;i++) {
                if(this._isLinkNeeded(i)) {
                    optionLinks += '<li><a class="ace_opt" data-ace-id="'+ i +'" href="javascript:;">' + this.options.linkText[i] + '</a>';
                }
            }
            return '<ul class="ace_dd" style="">' + optionLinks + '</ul>';
        },
...
!function(o){o("#navBtn").on("click",function(t){o(".nav-group").toggleClass("open"),o("#navBtn").toggleClass("active")}),o(".filter-btn").on("click",function(t){t.preventDefault(),o(".filter-drop").hasClass("open")||o(".js-facets-checkbox-links").css("display","none"),o(".filter-drop").toggleClass("open"),o(".cal-controls .filters > ul").toggleClass("open"),o(".controls").toggleClass("open"),o(".filter-btn").toggleClass("active")}),o(".proj-controls ul li.top a").on("click",function(t){t.preventDefault(),o(".filter-drop").hasClass("open")?0<o(".filter-drop .contain .band:eq("+(o(this).parent().prevAll().length-1)+")").length&&"block"!=o(".filter-drop .contain .band:eq("+(o(this).parent().prevAll().length-1)+")").css("display")?(o(".proj-controls ul li a").removeClass("active"),o(this).toggleClass("active"),o(".filter-drop .band").css("display","none"),o(".filter-drop .contain .band:eq("+(o(this).parent().prevAll().length-1)+")").css("display","block")):(o(".filter-drop").toggleClass("open"),o(".proj-controls ul li a").removeClass("active"),o(".filter-drop .band").css("display","none"),o(".controls").toggleClass("open")):(o(this).toggleClass("active"),o(".filters ul li a").not(o(this)).removeClass("active"),o(".filter-drop .band").css("display","none"),o(".filter-drop").toggleClass("open"),o(".filter-drop .contain .band:eq("+(o(this).parent().prevAll().length-1)+")").css("display","block"),o(".controls").toggleClass("open"))}),o(".cal-controls ul li a").on("click",function(t){o(this).toggleClass("active"),o(".cal-controls ul li a").not(o(this)).removeClass("active"),o(this).next(".sub").toggleClass("open"),o(".sub").not(o(this).next()).removeClass("open")}),o(".cal-item .lt .add").on("click",function(t){t.preventDefault(),o(this).toggleClass("open"),o(this).next(".cal-item .lt ul").toggleClass("open")}),0<o(".toggle .switch").length&&o(".toggle .switch").on("click",function(t){t.preventDefault(),o(this).parent().find(".switch").removeClass("active"),o(this).addClass("active"),o(this).hasClass("map")?(o(".proj-controls .filters").css("visibility","hidden"),o(".proj-grid, .pagination, .filter-toolbar").css("display","none"),o(".map-wrap").css("display","block")):(o(".proj-controls .filters").css("visibility","visible"),o(".proj-grid, .pagination").css("display","block"),1<o(".showing.filter-toolbar ul li").length&&o(".filter-toolbar").css("display","initial"),o(".map-wrap").css("display","none"))}),o(".grid .contain").each(function(){var t=0;o(".cont",this).each(function(){o(this).height()>t&&(t=o(this).height())}),o(".cont",this).height(t)}),o(".feat-slider-wrap .slider").slick({infinite:!0,slidesToShow:3,slidesToScroll:1,autoplay:!0,autoplaySpeed:5e3,responsive:[{breakpoint:992,settings:{slidesToShow:2}},{breakpoint:600,settings:{slidesToShow:1}}]}),o("#shareFacebook").on("click",function(t){t.preventDefault();var e=o(this).data("url")?o(this).data("url"):encodeURIComponent(window.location.href);window.open("https://www.facebook.com/sharer/sharer.php?u="+e)}),o("#shareTwitter").on("click",function(t){t.preventDefault();var e=o(this).data("url")?o(this).data("url"):encodeURIComponent(window.location.href),s=o(this).data("msg");window.open("https://twitter.com/home?status="+s+" - "+e+"&url="+e)}),o("#shareMail").on("click",function(t){t.preventDefault();var e=o(this).data("url")?o(this).data("url"):encodeURIComponent(window.location.href),s=o(this).data("msg");location.href="mailto:?subject="+s+"&body="+e});var s=function(){var t=(new Date).getTimezoneOffset(),e=Math.abs(t);return(t<0?"+":"-")+("00"+Math.floor(e/60)).slice(-2)+":"+("00"+e%60).slice(-2)};o(".add.caption").each(function(t){var e=moment(o(this).data("time")?o(this).data("time").toLowerCase().replace("a.m.","am").replace("p.m.","pm"):"",["h:mm A"]).format("HH:mm:ss");o(this).addcalevent({data:{title:o(this).data("title"),desc:o(this).data("desc"),location:o(this).data("location"),url:o(this).data("url"),time:{start:o(this).data("start")+" "+e,end:o(this).data("end")+" "+e,zone:s()}}})}),o(".facet-item .is-active").each(function(){var t=o(this).parent().find("a").data("drupal-facet-item-id");0==o(".controls .showing ul li[rel="+t+"]").length&&o(".controls .showing ul").append('<li style="cursor:pointer;" rel='+t+">"+o(this).parent().find(".facet-item__value").html()+' <span><img src="/themes/custom/arce/img/close-icon.svg"></span></li>')},function(){}),o(".proj-controls").delegate(".facets-widget-checkbox .top","click",function(){var t=o(this).parent().find(".js-facets-checkbox-links");t.slideToggle(300),o(".band .cont").not(t).slideUp(300),o(this).toggleClass("active"),o(".band .top").not(o(this)).removeClass("active")}),o(".showing ul").delegate("li","click",function(){var t=o(this).attr("rel");o("#"+t).click()}),o("#search-close").on("click",function(t){t.preventDefault(),o("#search-form").parent().removeClass("open")}),o("#main-search-icon").on("click",function(t){t.preventDefault(),o("#search-form").parent().addClass("open").find("input").focus().select()})}(jQuery);;
