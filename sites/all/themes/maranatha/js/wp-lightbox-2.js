...
/*2.28.4 -  Compatible with wordpress 3.6.*/
        ...
        function showImage() {
            ...
            /* T29 Change BEGIN */
            if ( opts.shareImage ) {
                var img_url = $( '#lightboxImage' ).attr( 'src' );
                var html = '<div id="lightbox-share-wrapper">'
                            + '<span class="lightbox-share-title">Share</span>'
                            + '<a class="social-icon facebook" href="https://www.facebook.com/sharer/sharer.php?u=' + img_url + '" target="_blank" title="Facebook">Facebook</a>'
                            + '<a class="social-icon gplus" href="https://plus.google.com/share?url=' + img_url + '" target="_blank" title="Google+">Google Plus</a>'
                            + '<a class="social-icon twitter" href="https://twitter.com/share?url=' + img_url + '" target="_blank" title="Twitter">Twitter</a>'
                            + '<a class="social-icon pinterest" href="https://pinterest.com/pin/create/button/?media=' + img_url + '" target="_blank" title="Pinterest">Pinterest</a>'
                            + '<a class="social-icon linkedin" href="http://www.linkedin.com/shareArticle?mini=true&url=' + img_url + '" target="_blank" title="LinkedIn">LinkedIn</a>'
                            + '<div class="clearfix"></div>';
                        + '</div>';

                if ( $( '#lightbox-share-wrapper' ).get(0) ) {
                    $( '#lightbox-share-wrapper' ).remove();
                }
                $( '#lightbox #imageDetails' ).append( html );
            }
            /* T29 Change END */
        };
