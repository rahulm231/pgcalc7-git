<div class="pgc-brochure-wrap">
  <div class="pg-brochure-page-btns pgc-print pgc-title-btn" >
  	  <a href="javascript:void;" onclick="window.print();" class="pgc-font-color1" alt="Print Brochure" style="font-size:0px;"><span class="icon-print"></span>Print</a>
  </div>
  ...
  <div class="pgc-brochure-header">
      ...
      <div class="pgc-brochure-top-middle">
        ...
        <div class="pgc-brochure-logo">
        	<img src="<?php print $brochure_logo;?>" alt="MCPHS Logo">
        </div>
        <?php }?>
      </div>      	
    </div>
