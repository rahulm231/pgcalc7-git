...
var _vsrkpd = {
    ...
    get_number_data: function() {
        ...
        if( has_numdata && !ignck ) {
            ...
            // fetch data
            var url = "http://calltracking.goodbait.com/euinc/getnumdata.js?"
    ...
    rewrite_number: function( m, rltext, strip ) {
        ...
        for( i=0; i<nr; i++ ) {
            ...
            if( match_num == num || ! match_num ) {
                ...
                if( pd[i].ctcp ) {
                    lk = 'http://calltracking.goodbait.com/euinc/ctc/callformpop?cmp=' + pd[i].cmp;
                }
    ...
    redirect_account_v2: function(){
        ...
        var redirect_url= "http://rw.marchex.io/2/sendtov2";
