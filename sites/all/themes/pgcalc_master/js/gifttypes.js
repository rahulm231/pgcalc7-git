(function ($) {
  Drupal.behaviors.giftTypes = {
    init: function() {
      ...
      // #MSE-7 - Starts
      $('.pg-gift-details .accordion-switch.accordion-expand').css('display', 'none');
      $('.pg-gift-details .accordion-switch').unbind('click').click(function(){
      	$('.pg-gift-details .accordion-switch').toggle();
      	$('.pg-gift-details .accordion-items').slideToggle('slow');
      	/*
