 ...
 * omnes-pro:
 *   - http://typekit.com/eulas/0000000000000000000175b5
 *   - http://typekit.com/eulas/0000000000000000000175b6
 *
...
window.Typekit.config = {
    "a": "26559",
    "c": [".tk-omnes-pro", "\"omnes-pro\",sans-serif", ".tk-alternate-gothic-no-3-d", "\"alternate-gothic-no-3-d\",sans-serif"],
    "dl": "AAAA5wAAAApWWfTQ0ipz677PAI3X9fC4qz--YlQTFNjc9pNgAAAAEA",
    "fi": [7998, 7999, 10328],
    "fc": [{
        "id": 7998,
        "family": "omnes-pro",
        "src": "/sites/all/themes/plan_international_usa/cssAssets/AlternateGotNo3DOT.otf",
        "descriptors": {
            "weight": "600",
            "style": "normal",
        ...
        "id": 7999,
        "family": "omnes-pro",
        "src": "https://use.typekit.net/af/302b75/0000000000000000000175b6/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "600",
            "style": "italic",
            "primer": "7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191"
    ...
    "fn": ["alternate-gothic-no-3-d", ["n4"], "omnes-pro", ["i6", "n6"]],
    "hn": "use.typekit.net",
    "ht": "tk",
    "js": "1.18.24",
    "kt": "wni1slf",
...
/*{"k":"1.18.24","auto_updating":true,"last_published":"2015-10-05 16:32:12 UTC"}*/
;
(function(window, document, undefined) {
    ...
    function oa(a, b) {
        if ("i" === b) {
            ...
            K(a, function(a) {
                a = G(a, a.b.replace(/(-1|-2)$/, "").slice(0, 28) + "-" + E(a));
                d.b.push(a)
            });
            return d
        }
    ...
    function qa(a, b, c) {
        for (var d = [], e = 0; e < b.length; e++) {
            ...
            "i" === f ? d.push("url(" + g + ")") : d.push("url(" + g + ') format("' + sa(f) + '")')
        }
        return d.join(",")
    }
    ...
    function va() {
        if (null === Q) {
            ...
            Q = !!a && (536 > parseInt(a[1], 10) || 536 === parseInt(a[1], 10) && 11 >= parseInt(a[2], 10))
        }
        return Q
    }
    ...
    function xa(a, b, c) {
        for (var d in P)
            if (P.hasOwnProperty(d) && b === a.g[P[d]] && c === a.g[P[d]]) return !0;
        return !1
    }
    ...
    za.prototype.start = function() {
        var a = this.m.g.document,
            ...
            d = new Promise(function(d, e) {
                function k() {
                    m() - c >= b.g ? e() : a.fonts.load(b.b.style + " " + b.b.weight + " 300px " + (b.j ? F(b.b) : b.b.b), b.o).then(function(a) {
            ...
            K(b, function(b) {
                ...
                if (null === T)
                    if (window.FontFace) {
                        ...
                        T = e ? 42 < parseInt(e[1], 10) : p && /Apple/.exec(window.navigator.vendor) ? 603 <= parseInt(p[1], 10) : !0
                    } else T = !1;
    ...
    S.prototype.j = function(a) {
        var b = this.b;
        if (b.i) {
            var c = ja(b.g, b.b.b("wf", a.b, E(a), "active")),
                d = [],
    ...
    U.prototype.supportsConfiguredBrowser = function() {
        return !0
    };
    ...
    U.prototype.load = function(a, b, c) {
        ...
        */
            ...
            active: function() {
                ...
                if (d.m) {
                    ...
                    for (var x = 0; x < a.b.length; x++) {
                        for (var pa = !1, Z = 0; Z < w.length; Z++)
                            if (a.b[x] === w[Z]) {
                                pa = !0;
                                break
                            }
                        pa || (l.push(a.b[x]), w.push(a.b[x]))
                    }
                    l.length && Ca(I(c, {
                        s: a.j,
                        k: a.o,
        ...
        if (g.b.length) {
            var k = L(g, f, this.i, e);
            A(this.b, k);
            var l = new S(this.b, c, a, e);
            ia(d.b, function() {
                Aa(l, g, b)
            })
        } else C(c)
    ...
    function Fa(a, b) {
        if (a.b.length) {
            for (var c = new B(a.g, b, {}), d = 0; d < a.b.length; d++) a.b[d].init();
    ...
    if (!window.Typekit.load) {
        var V = new Da(new H("//" + (window.Typekit.config || {}).hn + "/{id}.js"), Ha);
            ...
            a.fontactive = function(a, b) {
                ...
                a: {
                    ...
                    for (var l = n.fc, p = 0; p < l.length; p++)
                        if (l[p].family === a && l[p].descriptors.weight === k && l[p].descriptors.style === g) {
                            g = l[p].id;
                            break a
                        }
                    g = 0
