...
// Created: 8/22/2011 3:02:25 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcs9uo4q210000shcbccfbydd_5r6k";
	this.domain="iris.skidmore.edu";
	this.timezone=-5;
	this.fpcdom=".skidmore.edu";
	this.onsitedoms="imodules.com,skidmoreconnect.org,facebook.com,youtube.com";
	this.downloadtypes="xls,doc,pdf,txt,csv,zip,ppt,pptx,docx,xlsx";
