var BLACKBAUD=BLACKBAUD||{};BLACKBAUD.netcommunity={jQuery:{setVersionReference:function(){if(jQuery){var d="v"+jQuery().jquery.replace(/\./gi,"_");var g=d.slice(0,d.lastIndexOf("_"));var b=parseInt(d.slice(d.lastIndexOf("_")+1,d.length),10);if(d.split("_").length!==3){g=d;b=0;d+="_"+b}this[g]=jQuery;var e=false;for(var a=b;a>=0;a--){var c=g+"_"+a;if(this.compatibility[c]===false&&c==d){e=a}else{if(this.compatibility[c]===false&&c!=d){break}}var f;if(e===false){f=function(){return BLACKBAUD.netcommunity.jQuery[g].apply(null,arguments)};BLACKBAUD.netcommunity.jQuery[g].extend(f,BLACKBAUD.netcommunity.jQuery[g])}else{if(a!=b){f=function(){return BLACKBAUD.netcommunity.jQuery[g+"_"+e].apply(null,arguments)};BLACKBAUD.netcommunity.jQuery[g+"_"+e].extend(f,BLACKBAUD.netcommunity.jQuery[g+"_"+e])}else{f=jQuery}}this[c]=f}}},compatibility:{}},Platform:{}};
