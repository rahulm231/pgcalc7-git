...
<html lang="en">
  <head>
    ...
    <title>American Red Cross | Thank you, we'll be in touch soon.</title>
...
<!-- End Visual Website Optimizer Asynchronous Code -->
  ...
  <body>
   ...
   <!-- End Google Tag Manager (noscript) -->
          ...
          <div class="col-sm-12 thank-you">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                <h1 class="text-center">Thank you, we'll be in touch soon.</h1>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12 thank-you-copy">
                <div class="row">
                  <div class="col-sm-4 text-center photo"><img src="images/gift-illustration.jpg" alt="Gift Illustration" class="img-responsive img-shadow"></div>
                  <div class="col-sm-8">
                    <p>A member of our American Red Cross Gift Planning Team will contact you soon to develop your personalized gift illustration. In the meantime, please don't hesitate to reach out to us by email at <a href="mailto:GiftPlanning@redcross.org">GiftPlanning@redcross.org</a> or by phone at 1-800-797-8022, ext. 5 with any questions. We're happy to assist you and your advisors with your charitable planning.</p>
                  </div>
                </div>
              </div>
            </div> 
    ...
    <script>document.write('<s'+'cript language="JavaScript" src="http://view.atdmt.com/jaction/bvkarc_CGAConfirmationPage_1"></s'+'cript>')</script><noscript><iframe src="http://view.atdmt.com/iaction/bvkarc_CGAConfirmationPage_1" width="1" height="1" frameborder="0" scrolling="No" marginheight="0" marginwidth="0" topmargin="0" leftmargin="0"></iframe></noscript>
