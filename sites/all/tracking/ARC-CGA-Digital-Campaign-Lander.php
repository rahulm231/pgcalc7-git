              ...
              <div class="col-sm-12">
               <form method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>" name="" id="" role="form">
                  ...
                  <div class="checkbox checkbox-top-divider">
                    <label><input type="checkbox" name="optInForEmails" value="">I'd like to receive emails from the American Red Cross on planning for my future and other similar topics.</label>
                  </div>
