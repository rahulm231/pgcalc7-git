...
<html lang="en">
  ...
  <body>
   ...
   <!-- End Google Tag Manager (noscript) -->
          ...
          <div class="col-sm-12 thank-you">
            ...
            <div class="row">
              <div class="col-sm-12 thank-you-copy">
                <div class="row">
                  <div class="col-sm-4"><img src="images/donor-testimonial.jpg" alt="Charlotte Berry" class="img-responsive"></div>
                  <div class="col-sm-8">
	...
	<script>document.write('<s'+'cript language="JavaScript" src="http://view.atdmt.com/jaction/bvkarc_GeneralPlannedGivingConfirmationPage_1"></s'+'cript>')</script><noscript><iframe src="http://view.atdmt.com/iaction/bvkarc_GeneralPlannedGivingConfirmationPage_1" width="1" height="1" frameborder="0" scrolling="No" marginheight="0" marginwidth="0" topmargin="0" leftmargin="0"></iframe></noscript>
