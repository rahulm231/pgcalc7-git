...
<html lang="en">
  <head>
    ...
    <title>American Red Cross | Thank you, your request has been submitted.</title>
  ...
  <body>
   ...
   <!-- End Google Tag Manager (noscript) -->
    ...
    <section id="main">
      <div class="container">
        <div class="row">
          <div class="col-sm-12 thank-you">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                <h1 class="text-center">Thank you, your request has been submitted.</h1>
              </div>
            </div>
            <div class="row">
              <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                <a href="http://www.redcrosslegacy.org/pdf/WG.pdf" target="_blank" class="btn btn-default btn-block">Click Here to Download<br/>Your Guide &amp; Workbook</a>
              </div>
            </div>
            <div class="row">
              <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                <div class="row">
                  <div class="col-md-2 col-sm-3 col-xs-2 pdf-icon"><a href="https://get.adobe.com/reader/" target="_blank"><img src="images/icon-pdf.png" alt="PDF" class="img-responsive"></a></div>
                  <div class="col-md-10 col-sm-9 col-xs-10 pdf">You will need Adobe&reg; Reader&reg; (version 8.0 or newer) to view this document.</div>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12 thank-you-copy">
                <div class="row">
                  <div class="col-sm-4 text-center photo"><img src="images/epwb.jpg" alt="Estate Planning Guide &amp; Workbook" class="img-responsive"></div>
                  <div class="col-sm-8">
<?php /* No Checkboxes */ if (($_SESSION["wgBooklet"]=="") && ($_SESSION["wgArcInWill"]=="") && ($_SESSION["wgConsiderArcInWill"]=="")) {?>  
              <p> We hope you find your FREE interactive copy of <em>Touching the Future</em> a useful, timesaving tool. This resource will allow you to save your personal information in one place, make future edits when needed and print multiple copies to share with your attorney and family members. </p>

<p>If you have any questions, please don't hesitate to reach out to us by email at <a href="mailto:GiftPlanning@redcross.org">GiftPlanning@redcross.org</a> or by phone at 1-800-797-8022, ext. 5. We're happy to assist you and your advisors with your charitable planning. </p>
<?php } ?>
<?php /* Only wgbooklet*/ if (($_SESSION["wgBooklet"]=="1") && ($_SESSION["wgArcInWill"]=="") && ($_SESSION["wgConsiderArcInWill"]=="")) {?>  
<p>Your FREE hard copy of <em>Touching the Future</em> will be delivered to the address you provided. Please allow 3-4 weeks for delivery. In the meantime, we hope you find your FREE interactive copy of <em>Touching the Future</em> a useful, timesaving tool. This resource will allow you to save your personal information in one place, make future edits when needed and print multiple copies to share with your attorney and family members.</p>

<p>If you have any questions, please don't hesitate to reach out to us by email at <a href="mailto:GiftPlanning@redcross.org">GiftPlanning@redcross.org</a> or by phone at 1-800-797-8022, ext. 5. We're happy to assist you and your advisors with your charitable planning.</p>
<?php } ?>

<?php /* Only wgArcInWill*/ if (($_SESSION["wgBooklet"]=="") && ($_SESSION["wgArcInWill"]=="1") && ($_SESSION["wgConsiderArcInWill"]=="")) {?>  
<p>We hope you find your FREE interactive copy of <em>Touching the Future</em> a useful, timesaving tool. This resource will allow you to save your personal information in one place, make future edits when needed and print multiple copies to share with your attorney and family members.
</p>
<p>Your local Red Cross representative will contact you to personally offer our thanks and appreciation for your gift. We honor every planned gift donor with membership in the Legacy Society. To learn more about becoming a Legacy Society member, visit <a href="http://www.redcrosslegacy.org/why-give/legacy-society" target="_blank">www.redcrosslegacy.org/why-give/legacy-society</a>.</p>
...
<p>If you have any questions, please don't hesitate to reach out to us by email at <a href="mailto:GiftPlanning@redcross.org">GiftPlanning@redcross.org</a> or by phone at 1-800-797-8022, ext. 5. We're happy to assist you and your advisors with your charitable planning.
</p>
...
<!--<p>Your FREE hard copy of <em>Touching the Future</em> will be delivered to the address you provided. Please allow 3-4 weeks for delivery. In the meantime, we hope you find your FREE interactive copy of <em>Touching the Future</em> a useful, timesaving tool. This resource will allow you to save your personal information in one place, make future edits when needed and print multiple copies to share with your attorney and family members.</p>
                    <p>Your local Red Cross representative will be in touch soon to provide you with more information on how you can make a gift through your will, trust or another gift plan &ndash; such as a beneficiary of your retirement account or insurance policy. We honor every planned gift donor with membership in the Legacy Society. To learn more about becoming a Legacy Society member, visit <a href="http://www.redcrosslegacy.org/why-give/legacy-society" target="_blank">www.redcrosslegacy.org/why-give/legacy-society.</a></p>
                    <p>If you have any questions, please don't hesitate to reach out to us by email at <a href="mailto:GiftPlanning@redcross.org">GiftPlanning@redcross.org</a> or by phone at 1-800-797-8022, ext. 5. We're happy to assist you and your advisors with your charitable planning.</p>-->
                  </div>
                </div>
              </div>
