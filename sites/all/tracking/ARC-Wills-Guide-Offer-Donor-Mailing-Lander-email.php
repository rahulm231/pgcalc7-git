...
if (($_SESSION["wgBooklet"]=="1")) {
	$message.="<p>I would also like a booklet version of the FREE guide and workbook mailed to me.</p>";
	}
if (($_SESSION["wgArcInWill"]=="1") ) {
...
if ( ($_SESSION["wgConsiderArcInWill"]=="1")) {
	$message.="<p>I would consider a gift to the Red Cross in my will.</p>";
	}
...
<?php /* wgArcInWill and wgConsiderArcInWill */ if (($_SESSION["wgBooklet"]=="") && ($_SESSION["wgArcInWill"]=="1") && ($_SESSION["wgConsiderArcInWill"]=="")) { 
...
<?php /* ALL 3 */ if (($_SESSION["wgBooklet"]=="1") && ($_SESSION["wgArcInWill"]=="1") && ($_SESSION["wgConsiderArcInWill"]=="1")) { 
$subject="Your Red Cross Will Planning Guide & Gift Notification";
$message2="
<p>Dear $first_name,</p>
...
<?php /* wgBooklet and wgArcInWill */ if (($_SESSION["wgBooklet"]=="1") && ($_SESSION["wgArcInWill"]=="1") && ($_SESSION["wgConsiderArcInWill"]=="")) { 
$subject="Your Red Cross Will Planning Guide & Gift Notification";
$message2="
<p>Dear $first_name,</p>
...
<?php /* wgBooklet and wgConsiderArcInWill*/ if (($_SESSION["wgBooklet"]=="1") && ($_SESSION["wgArcInWill"]=="") && ($_SESSION["wgConsiderArcInWill"]=="1")) { 
$subject="Your Red Cross Will Planning Guide & Information Request";
$message2="
<p>Dear $first_name,</p>
...
<?php /* wgArcInWill and wgConsiderArcInWill*/ if (($_SESSION["wgBooklet"]=="") && ($_SESSION["wgArcInWill"]=="1") && ($_SESSION["wgConsiderArcInWill"]=="1")) { 
$subject="Your Red Cross Will Planning Guide & Gift Notification";
$message2="
<p>Dear $first_name,</p>
