                ...
                <div class="row">
                  <div class="col-sm-6 hidden-xs">
                    <ul class="secondary">
                      ...
                      <li>Want fixed lifelong income</li>
                    </ul>
                  </div>
              ...
              <div class="col-sm-12">
               <form method="post" action="<?=$_SERVER['REQUEST_URI'];?>" name="" id="" role="form">
                  ...
                  <div class="checkbox bottom-divider">
                      ...
                      <div class="row">
                        <div class="col-sm-12"><label for="cgaOtherAmount"><input type="checkbox" name="cgaOtherAmountcheck" id="cgaOtherAmountcheck" value="">Other Amount:&nbsp;&nbsp;</label><input type="text" name="cgaOtherAmount" id="cgaOtherAmount" value="<?=$_SESSION["cgaOtherAmount"]; ?>"></div>
                      </div>
                  </div>

                  <!--Start Age-->
                  <div class="form-callout bottom-divider" style="border-bottom:0px;margin-bottom:0px">At what age would you like the income stream from your gift to start?<span>*</span></div>
                    <div class="form-group"><input type="text" name="cgaStartage" value="<?=$_SESSION["cgaStartage"]; ?>" id="cgaStartage" class="form-control" /></div>

                  <!--CTA button-->
                  <div class="form-group"> 
                  <input type="text"   name="lander_type" style="display:none;" value="Donor Mailing CGA Illustration Request">
