            ...
            <div class="row">
              <div class="col-sm-12">
               <form method="post" action="<?=$_SERVER['REQUEST_URI'];?>" name="" id="" role="form">
                  ...
                  <div class="checkbox">
                    <label><input type="checkbox" name="wgBooklet" value="<?=$_SESSION["wgBooklet"]; ?>">I would also like a booklet version of the FREE guide and workbook mailed to me.</label>
                  </div>
