              ...
              <div class="col-sm-12">
               <form method="post" action="<?=$_SERVER['REQUEST_URI'];?>" name="" id="" role="form">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="professional_title" value="<?=$_SESSION["professional_title"]; ?>" id="professional_title" class="form-control" />
                  </div>
                  <div class="form-group">
                    <label for="company_name">Company Name</label>
                    <input type="text" name="company_name" value="<?=$_SESSION["company_name"]; ?>" id="company_name" class="form-control" />
                  </div>
                  <div class="form-group">
                  ...
                  <div class="checkbox bottom-divider">
                    <label><input type="checkbox" name="wgBooklet" value="<?=$_SESSION["wgBooklet"]; ?>"  >I would like a booklet version of the FREE guide and workbook mailed to me.</label>
                  </div>
                  <div class="checkbox">
