<?php include('connection.php');
  // query to fetch all records then write them in excell file
  
    if(file_exists('mailers_db.xls')){
      unlink('mailers_db.xls');	
    }
    ...
    $fp = fopen("mailers_db.xls","a"); // $fp is now the file pointer to file $filename
	...
	mysqli_close($conn);
?>
<a href='mailers_db.xls'>Download Mailers History Here !</a>
