          ...
          <div class="col-sm-7 main">
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <p>This informative 44-page resource comes in an <strong>easy-to-use electronic file</strong> (PDF) that you can edit and save as needed.</p>
            ...
            <div class="row">
              <div class="col-sm-12">
               <form method="post" action="<?=$_SERVER['REQUEST_URI'];?>" name="" id="" role="form">
                  ...
                  <div class="form-callout bottom-divider">Many people like to leave a charity in their will because they care about causes that have been important in their lives.</div>
                  <div class="checkbox">
                    <label><input type="checkbox" name="wgArcInWill" value="<?=$_SESSION["wgArcInWill"]; ?>">I already included the Red Cross in my will, trust or another gift plan, such as a beneficiary of my retirement account or insurance policy.</label>
                  </div>
                  <div class="checkbox">
                    <label><input type="checkbox" name="wgConsiderArcInWill" value="<?=$_SESSION["wgConsiderArcInWill"]; ?>">I would consider a gift to the Red Cross in my will.</label>
                  </div>
                  <div class="form-group"> 
