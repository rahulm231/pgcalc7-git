...
<html lang="en">
  ...
  <body>
   ...
   <!-- End Google Tag Manager (noscript) -->
              ...
              <div class="col-sm-12">
               <form method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>" name="" id="" role="form">
                  ...
                  <div class="checkbox bottom-divider">
                    <label><input type="checkbox" name="considerCharityInWill" value="<?php echo $_SESSION["considerCharityInWill"]; ?>">Many people like to leave a charity in their will because they care about causes that have been important in their lives. I would consider a gift to charity in my will.</label>
                  </div>
                  <div class="checkbox">
                    <label><input type="checkbox" name="optInForEmails" value="<?php echo $_SESSION["optInForEmails"]; ?>">I would like to receive emails from the American Red Cross on planning for my future and other similar topics.</label>
                  </div>
                  <div class="form-group"> 
                  <input type="text"   name="lander_type" style="display:none;" value="Digital Campaign WG Request">
	...
	<script>document.write('<s'+'cript language="JavaScript" src="http://view.atdmt.com/jaction/bvkarc_WillsGuideLandingPage_1"></s'+'cript>')</script><noscript><iframe src="http://view.atdmt.com/iaction/bvkarc_WillsGuideLandingPage_1" width="1" height="1" frameborder="0" scrolling="No" marginheight="0" marginwidth="0" topmargin="0" leftmargin="0"></iframe></noscript>
